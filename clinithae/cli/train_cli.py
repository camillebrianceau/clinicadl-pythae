...
from clinithae.trainer.pythae_train import train_pythae

@click.command(name="train-reconstruction", no_args_is_help=True)
 # Mandatory arguments
...
def cli(
    ...
    train_pythae(maps_manager, split_list=split)